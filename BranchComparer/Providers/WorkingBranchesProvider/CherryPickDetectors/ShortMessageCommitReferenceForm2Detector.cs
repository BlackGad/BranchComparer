...
internal class ShortMessageCommitReferenceForm2Detector : ICherryPickDetector
{
    ...
    {
        var leftTable = left.ToDictionary(c => c.Id);
        var rightTable = right.ToDictionary(c => c.Id);
